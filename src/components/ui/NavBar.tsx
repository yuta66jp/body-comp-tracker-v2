...
export function NavBar() {
  ...
  return (
    <nav className="sticky top-0 z-20 hidden border-b border-slate-200/80 bg-white/80 backdrop-blur-md md:block dark:border-slate-700/60 dark:bg-slate-900/80">
      <div className="mx-auto flex max-w-5xl items-center gap-0.5 px-4 py-2.5">
        ...
        <div className="mr-5 flex items-center gap-2">
          ...
          <span className="hidden text-sm font-bold text-slate-800 dark:text-slate-100 sm:block">Tracker</span>
        </div>
